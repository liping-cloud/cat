	...
	<div class="app-container">
		<el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
			...
			<el-form-item label="申请金额" prop="applyMoney">
				<el-input v-model="queryParams.applyMoney" placeholder="请输入申请金额" clearable @keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item label="0：待审核；1：待打款；2：已打款；3：拒绝" prop="applyState">
				<el-input v-model="queryParams.applyState" placeholder="请输入0：待审核；1：待打款；2：已打款；3：拒绝" clearable @keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item label="申请时间" prop="applyTime">
				<el-date-picker clearable v-model="queryParams.applyTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择申请时间"> </el-date-picker>
			</el-form-item>
		...
		<el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="申请金额" align="center" prop="applyMoney" />
			<el-table-column label="0：待审核；1：待打款；2：已打款；3：拒绝" align="center" prop="applyState" />
		...
		<el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				...
				<el-form-item label="申请金额" prop="applyMoney">
					<el-input v-model="form.applyMoney" placeholder="请输入申请金额" />
				</el-form-item>
				<el-form-item label="0：待审核；1：待打款；2：已打款；3：拒绝" prop="applyState">
					<el-input v-model="form.applyState" placeholder="请输入0：待审核；1：待打款；2：已打款；3：拒绝" />
				</el-form-item>
				<el-form-item label="申请时间" prop="applyTime">
					<el-date-picker clearable v-model="form.applyTime" type="date" value-format="yyyy-MM-dd" placeholder="请选择申请时间"> </el-date-picker>
				</el-form-item>
				<el-form-item label="备注" prop="remarks">
...
<script>
import { listTable, getTable, delTable, addTable, updateTable } from '@/api/system/withdrawal';
...
export default {
	...
	methods: {
		...
		handleDelete(row) {
			...
			this.$modal
				.confirm('是否确认删除提现申请编号为"' + ids + '"的数据项？')
				.then(function () {
					return delTable(ids);
				})
				.then(() => {
